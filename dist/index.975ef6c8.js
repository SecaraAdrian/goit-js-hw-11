...
async function fetchImages(name, page) {
    try {
        const response = await (0, _axiosDefault.default).get(`https://pixabay.com/api/?key=32796055-430da42c5dde817f5aba040d6&q=${name}&image_type=photo&orientation=horizontal&safesearch=true&page=${page}&per_page=${perPage}`);
...
async function eventHandler(ev) {
    ...
    fetchImages(name, page).then((name)=>{
        ...
        if (name.hits.length > 0) {
            (0, _notiflixDefault.default).Notify.success(`Hooray! We found ${name.totalHits} images.`);
            renderGallery(name);
            ...
            if (page < totalPages) loadBtn.style.display = "block";
            else {
                loadBtn.style.display = "none";
...
themeSwitchBtn.addEventListener("click", toggleMode);
function toggleMode() {
...
},{"./css/styles.css":"1CY4s","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","notiflix":"fuMq1","axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1CY4s":[function() {},{}],"9ydBq":[function(require,module,exports) {
/*!
...
},{}],"kaxSc":[function() {},{}],"fuMq1":[function(require,module,exports) {
var global = arguments[3];
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["farZc","8lqZg"], "8lqZg", "parcelRequirea610")
